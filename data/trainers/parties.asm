...
FalknerGroup:
	...
	db 13, PIDGEY,    BERRY,     QUICK_ATTACK, SAND_ATTACK, GUST, TACKLE
	db 15, FARFETCH_D,    BERRY,  PECK, MUD_SLAP, LEER, FURY_ATTACK
	db 14, HOOTHOOT,    BERRY,     PECK, HYPNOSIS, CONFUSION, TAKE_DOWN
	db 16, PIDGEOTTO,    BERRY,  TACKLE, MUD_SLAP, GUST, QUICK_ATTACK
	db 15, GYARADOS,    BERRY,     BODY_SLAM, ICE_BEAM, THUNDERBOLT, SURF
	db 16, AERODACTYL,    BERRY,  BITE, WING_ATTACK, SUPERSONIC, DOUBLE_TEAM
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 30, CLEFABLE,    GOLD_BERRY,     THUNDERBOLT, BLIZZARD, PSYCHIC_M, SING
	db 30, WIGGLYTUFF,   GOLD_BERRY,  THUNDERBOLT, BLIZZARD, PSYCHIC_M, SING
	db 32, TAUROS,    GOLD_BERRY,     THUNDER, BLIZZARD, EARTHQUAKE, BODY_SLAM
	db 34, URSARING,    GOLD_BERRY,  TACKLE, MUD_SLAP, GUST, QUICK_ATTACK
	db 31, MILTANK,    GOLD_BERRY,     THUNDERBOLT, BLIZZARD, BODY_SLAM, EARTHQUAKE
	db 35, NIDOQUEEN,    GOLD_BERRY,  BLIZZARD, THUNDERBOLT, EARTHQUAKE, LOVELY_KISS
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 22, PINECO,    GOLD_BERRY,     ROCK_SMASH, GIGA_DRAIN, SELFDESTRUCT, DOUBLE_EDGE
	db 22, BUTTERFREE,   GOLD_BERRY,  PSYBEAM, SLEEP_POWDER, STUN_SPORE, MEGA_DRAIN
	db 24, BEEDRILL,    GOLD_BERRY,     TWINEEDLE, POISON_STING, FURY_ATTACK, FOCUS_ENERGY
	db 24, SCYTHER,    GOLD_BERRY,  SWORDS_DANCE, FURY_CUTTER, QUICK_ATTACK, WING_ATTACK
	db 27, PARASECT,    GOLD_BERRY,     FURY_CUTTER, SPORE, SLASH, GIGA_DRAIN
	db 25, HERACROSS,    GOLD_BERRY,  ROCK_SMASH, EARTHQUAKE, MEGAHORN, TAKE_DOWN
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 37, HAUNTER,    GOLD_BERRY,     NIGHT_SHADE, SHADOW_BALL, HYPNOSIS, CONFUSE_RAY
	db 38, ARBOK,   GOLD_BERRY,  SLUDGE_BOMB, EARTHQUAKE, GLARE, BODY_SLAM
	db 39, UMBREON,    GOLD_BERRY,     TWINEEDLE, POISON_STING, FURY_ATTACK, FOCUS_ENERGY
	db 42, GENGAR,    GOLD_BERRY,  HYPNOSIS, SHADOW_BALL, THUNDERBOLT, MEGA_DRAIN
	db 41, GOLBAT,    GOLD_BERRY,     MEGA_DRAIN, HYPNOSIS, SLUDGE_BOMB, WING_ATTACK
	db 40, MISDREAVUS,    GOLD_BERRY,  PSYBEAM, SHADOW_BALL, THUNDERBOLT, DOUBLE_TEAM
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 48, CLOYSTER,    GOLD_BERRY,     SPIKES, SURF, BLIZZARD, TRI_ATTACK
	db 46, BLASTOISE,   GOLD_BERRY,  BLIZZARD, EARTHQUAKE, HYDRO_PUMP, BODY_SLAM
	db 48, JYNX,    GOLD_BERRY,     LOVELY_KISS, BLIZZARD, PSYCHIC_M, BODY_SLAM
	db 46, LAPRAS,    GOLD_BERRY,  SING, BLIZZARD, THUNDERBOLT, HYDRO_PUMP
	db 51, DEWGONG,    GOLD_BERRY,     BLIZZARD, SURF, BODY_SLAM, HORN_DRILL
	db 50, PILOSWINE,    GOLD_BERRY,  BLIZZARD, EARTHQUAKE, HORN_ATTACK, ICY_WIND
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 58, SKARMORY,    GOLD_BERRY,     DRILL_PECK, TOXIC, SANDSTORM, SWAGGER
	db 58, SCIZOR,   GOLD_BERRY,  HIDDEN_POWER, DOUBLE_EDGE, AGILITY, STEEL_WING
	db 58, AERODACTYL,    GOLD_BERRY,     WING_ATTACK, ANCIENTPOWER, EARTHQUAKE, BITE
	db 58, OMASTAR,    GOLD_BERRY,  HYDRO_PUMP, BLIZZARD, SANDSTORM, SUBMISSION
	db 58, KABUTOPS,    GOLD_BERRY,     BLIZZARD, SURF, BODY_SLAM, ANCIENTPOWER
	db 60, STEELIX,    GOLD_BERRY,  EARTHQUAKE, IRON_TAIL, SANDSTORM, ROCK_SLIDE
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 53, PRIMEAPE,    GOLD_BERRY,     CROSS_CHOP, ROCK_SLIDE, THUNDERPUNCH, ICE_PUNCH
	db 55, HITMONCHAN,   GOLD_BERRY,  SUBMISSION, SEISMIC_TOSS, ICE_PUNCH, THUNDERPUNCH
	db 54, HITMONLEE,    GOLD_BERRY,     EARTHQUAKE, ROCK_SLIDE, HI_JUMP_KICK, BODY_SLAM
	db 53, MACHAMP,    GOLD_BERRY,  BODY_SLAM, EARTHQUAKE, ROCK_SLIDE, SUBMISSION
	db 57, HERACROSS,    GOLD_BERRY,     EARTHQUAKE, ROCK_SMASH, MEGAHORN, TAKE_DOWN
	db 55, POLIWRATH,    GOLD_BERRY,  LOVELY_KISS, EARTHQUAKE, BLIZZARD, HYDRO_PUMP
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 68, GYARADOS,    GOLD_BERRY,     BODY_SLAM, HYDRO_PUMP, BLIZZARD, THUNDERBOLT
	db 66, FERALIGATR,   GOLD_BERRY,  DYNAMICPUNCH, EARTHQUAKE, BLIZZARD, ROCK_SMASH
	db 70, NIDOKING,    GOLD_BERRY,     EARTHQUAKE, BLIZZARD, THUNDERBOLT, LOVELY_KISS
	db 68, DRAGONITE,    GOLD_BERRY,  DOUBLE_EDGE, OUTRAGE, BLIZZARD, THUNDERBOLT
	db 66, CHARIZARD,    GOLD_BERRY,     FIRE_BLAST, EARTHQUAKE, SLASH, OUTRAGE
	db 70, KINGDRA,    GOLD_BERRY,  HYDRO_PUMP, DRAGONBREATH, BLIZZARD, REST
	db -1 ; end
...
Rival1Group:
	...
	db 23, EEVEE,    GOLD_BERRY,     QUICK_ATTACK, DOUBLE_EDGE, SHADOW_BALL, DIG
	db 23, KADABRA,    GOLD_BERRY,     THUNDERPUNCH, ICE_PUNCH, PSYBEAM, RECOVER
	db 23, RATICATE,    GOLD_BERRY,     THUNDERBOLT, ICE_BEAM, BUBBLEBEAM, HYPER_FANG
	db 23, BAYLEEF,    GOLD_BERRY,     RAZOR_LEAF, BODY_SLAM, SYNTHESIS, SWORDS_DANCE
	db -1 ; end
	...
	db 23, KADABRA,    GOLD_BERRY,     THUNDERPUNCH, ICE_PUNCH, PSYBEAM, RECOVER
	db 23, RATICATE,    GOLD_BERRY,     THUNDERBOLT, ICE_BEAM, BUBBLEBEAM, HYPER_FANG
	db 23, QUILAVA,    GOLD_BERRY,     FLAMETHROWER, DIG, SUBMISSION, HEADBUTT
	db -1 ; end
	...
	db 23, KADABRA,    GOLD_BERRY,     THUNDERPUNCH, ICE_PUNCH, PSYBEAM, RECOVER
	db 23, RATICATE,    GOLD_BERRY,     THUNDERBOLT, ICE_BEAM, BUBBLEBEAM, HYPER_FANG
	db 23, CROCONAW,    GOLD_BERRY,     SURF, DYNAMICPUNCH, DIG, ICE_PUNCH
	db -1 ; end

	; RIVAL1 (7)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 36, URSARING,    GOLD_BERRY,     EARTHQUAKE, SLASH, THUNDERPUNCH, ICE_PUNCH
	db 38, ESPEON,    GOLD_BERRY,   PSYBEAM, MORNING_SUN, SHADOW_BALL, SWIFT
	db 38, AERODACTYL,    GOLD_BERRY,      ANCIENTPOWER, EARTHQUAKE, BITE, WING_ATTACK
	db 40, DEWGONG,    GOLD_BERRY,    BLIZZARD, SURF, BODY_SLAM, HORN_DRILL
	db 40, BAYLEEF,    GOLD_BERRY,    RAZOR_LEAF, BODY_SLAM, SYNTHESIS, SWORDS_DANCE
	db -1 ; end
	...
	db 38, AERODACTYL,    GOLD_BERRY,      ANCIENTPOWER, EARTHQUAKE, BITE, WING_ATTACK
	db 40, DEWGONG,    GOLD_BERRY,    BLIZZARD, SURF, BODY_SLAM, HORN_DRILL
	db 40, QUILAVA,    GOLD_BERRY,    FLAMETHROWER, DIG, SUBMISSION, HEADBUTT
	db -1 ; end
	...
	db 38, ESPEON,    GOLD_BERRY,   PSYBEAM, MORNING_SUN, SHADOW_BALL, SWIFT
	db 38, AERODACTYL,    GOLD_BERRY,      ANCIENTPOWER, EARTHQUAKE, BITE, WING_ATTACK
	db 40, ARCANINE,    GOLD_BERRY,    EXTREMESPEED, FLAMETHROWER, IRON_TAIL, CRUNCH
	db 40, CROCONAW,    GOLD_BERRY,   SURF, DYNAMICPUNCH, DIG, ICE_PUNCH
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 58, URSARING,    GOLD_BERRY,     EARTHQUAKE, SLASH, THUNDERPUNCH, ICE_PUNCH
	db 58, ESPEON,    GOLD_BERRY,   PSYBEAM, MORNING_SUN, SHADOW_BALL, SWIFT
	db 58, AERODACTYL,    GOLD_BERRY,      ANCIENTPOWER, EARTHQUAKE, BITE, WING_ATTACK
	db 56, DEWGONG,    GOLD_BERRY,    BLIZZARD, SURF, BODY_SLAM, HORN_DRILL
	db 60, MEGANIUM,    GOLD_BERRY,    RAZOR_LEAF, BODY_SLAM, SYNTHESIS, SWORDS_DANCE
	db -1 ; end
	...
	db 58, AERODACTYL,    GOLD_BERRY,      ANCIENTPOWER, EARTHQUAKE, BITE, WING_ATTACK
	db 56, DEWGONG,    GOLD_BERRY,    BLIZZARD, SURF, BODY_SLAM, HORN_DRILL
	db 60, TYPHLOSION,    GOLD_BERRY,    FLAMETHROWER, DIG, SUBMISSION, HEADBUTT
	db -1 ; end
	...
	db 58, ESPEON,    GOLD_BERRY,   PSYBEAM, MORNING_SUN, SHADOW_BALL, SWIFT
	db 58, AERODACTYL,    GOLD_BERRY,      ANCIENTPOWER, EARTHQUAKE, BITE, WING_ATTACK
	db 56, ARCANINE,    GOLD_BERRY,    EXTREMESPEED, FLAMETHROWER, IRON_TAIL, CRUNCH
	db 60, FERALIGATR,    GOLD_BERRY, RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 64, CLEFABLE,    GOLD_BERRY,    THUNDERBOLT, BLIZZARD, PSYCHIC_M, SING
	db 66, ALAKAZAM,    GOLD_BERRY,     PSYCHIC_M, THUNDERPUNCH, ICE_PUNCH, RECOVER
	db 66, ARCANINE,    GOLD_BERRY,   EXTREMESPEED, FIRE_BLAST, IRON_TAIL, CRUNCH
	db 66, GENGAR,    GOLD_BERRY,    HYPNOSIS, SHADOW_BALL, THUNDERBOLT, MEGA_DRAIN
	db 68, TYRANITAR,    GOLD_BERRY,    EARTHQUAKE, ROCK_SLIDE, CRUNCH, HYPER_BEAM
	db 70, MEGANIUM,    GOLD_BERRY,   EARTHQUAKE, RAZOR_LEAF, SYNTHESIS, BODY_SLAM
	db -1 ; end
	...
	db 64, CLEFABLE,    GOLD_BERRY,    THUNDERBOLT, BLIZZARD, PSYCHIC_M, SING
	db 66, ALAKAZAM,    GOLD_BERRY,     PSYCHIC_M, THUNDERPUNCH, ICE_PUNCH, RECOVER
	db 66, EXEGGUTOR,    GOLD_BERRY,   THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 66, GENGAR,    GOLD_BERRY,    HYPNOSIS, SHADOW_BALL, THUNDERBOLT, MEGA_DRAIN
	db 68, TYRANITAR,    GOLD_BERRY,    EARTHQUAKE, ROCK_SLIDE, CRUNCH, HYPER_BEAM
	db 70, TYPHLOSION,    GOLD_BERRY,      SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 66, GENGAR,    GOLD_BERRY,    HYPNOSIS, SHADOW_BALL, THUNDERBOLT, MEGA_DRAIN
	db 68, TYRANITAR,    GOLD_BERRY,    EARTHQUAKE, ROCK_SLIDE, CRUNCH, HYPER_BEAM
	db 70, FERALIGATR,    GOLD_BERRY,   HYDRO_PUMP, DYNAMICPUNCH, DIG, BLIZZARD
	db -1 ; end
...
WillGroup:
	...
	db 72, ESPEON,    GOLD_BERRY,       PSYCHIC_M, BITE, ZAP_CANNON, REFLECT
	db 70, JYNX,    GOLD_BERRY,       SHADOW_BALL, LOVELY_KISS, BLIZZARD, PSYCHIC_M
	db 73, EXEGGUTOR,    GOLD_BERRY,  SLEEP_POWDER, GIGA_DRAIN, EGG_BOMB, PSYCHIC_M
	db 73, SLOWBRO,    GOLD_BERRY,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 70, ALAKAZAM,    GOLD_BERRY,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 75, HYPNO,    GOLD_BERRY,       HYPNOSIS, PSYCHIC_M, POISON_GAS, MEGA_KICK
	db -1 ; end
...
BrunoGroup:
	...
	db 72, HERACROSS,    GOLD_BERRY,  MEGAHORN, EARTHQUAKE, COUNTER, STRENGTH
	db 70, RHYDON,    GOLD_BERRY,  EARTHQUAKE, ROCK_SLIDE, BODY_SLAM, DYNAMICPUNCH
	db 70, POLIWRATH,    GOLD_BERRY, LOVELY_KISS, HYDRO_PUMP, BLIZZARD, EARTHQUAKE
	db 70, PRIMEAPE,    GOLD_BERRY,       CROSS_CHOP, ROCK_SLIDE, THUNDERPUNCH, ICE_PUNCH
	db 72, MACHAMP,    GOLD_BERRY,    CROSS_CHOP, ROCK_SLIDE, EARTHQUAKE, FIRE_BLAST
	db 72, ONIX,    GOLD_BERRY,    ROCK_SLIDE, EARTHQUAKE, BODY_SLAM, SANDSTORM
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 71, UMBREON,    GOLD_BERRY,    PSYCHIC_M, ZAP_CANNON, FAINT_ATTACK, MOONLIGHT
	db 68, VILEPLUME,    GOLD_BERRY,  SLEEP_POWDER, BODY_SLAM, SLUDGE_BOMB, PETAL_DANCE
	db 70, GENGAR,    GOLD_BERRY,     LICK, SPITE, CURSE, DESTINY_BOND
	db 68, WEEZING,    GOLD_BERRY,    SLUDGE_BOMB, THUNDERBOLT, FIRE_BLAST, EXPLOSION
	db 71, VICTREEBEL,    GOLD_BERRY,   SLEEP_POWDER, RAZOR_LEAF, SLUDGE_BOMB, BODY_SLAM
	db 73, HOUNDOOM,    GOLD_BERRY,   FLAMETHROWER, SHADOW_BALL, SUNNY_DAY, SOLARBEAM
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_ITEM_MOVES
	db 72, VENOMOTH,    GOLD_BERRY,    SLUDGE_BOMB, MEGA_DRAIN, PSYCHIC_M, SLEEP_POWDER
	db 71, TENTACRUEL,    GOLD_BERRY,   BLIZZARD, HYDRO_PUMP, SLUDGE_BOMB, MEGA_DRAIN
	db 70, ARBOK,    GOLD_BERRY, SLUDGE_BOMB, EARTHQUAKE, GIGA_DRAIN, GLARE
	db 70, MUK,     GOLD_BERRY,       SLUDGE_BOMB, THUNDERBOLT, FIRE_BLAST, GIGA_DRAIN
	db 74, GENGAR,     GOLD_BERRY,    HYPNOSIS, SHADOW_BALL, THUNDERBOLT, GIGA_DRAIN
	db 74, NIDOKING,     GOLD_BERRY,    LOVELY_KISS, THUNDERBOLT, BLIZZARD, EARTHQUAKE
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 73, GYARADOS,    GOLD_BERRY,     BODY_SLAM, BLIZZARD, HYDRO_PUMP, THUNDERBOLT
	db 72, TYRANITAR,    GOLD_BERRY,    CRUNCH, EARTHQUAKE, ROCK_SLIDE, HYPER_BEAM
	db 71, KINGDRA,    GOLD_BERRY,       DRAGONBREATH, SURF, BLIZZARD, REST
	db 71, AERODACTYL,    GOLD_BERRY,     FLY, ANCIENTPOWER, EARTHQUAKE, IRON_TAIL
	db 75, CHARIZARD,    GOLD_BERRY,      FIRE_BLAST, EARTHQUAKE, SLASH, OUTRAGE
	db 75, DRAGONITE,    GOLD_BERRY,      THUNDER_WAVE, OUTRAGE, SURF, THUNDERBOLT
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_ITEM_MOVES
	db 80, GOLEM,    GOLD_BERRY,       BODY_SLAM, ROCK_SLIDE, EXPLOSION, EARTHQUAKE
	db 78, SUDOWOODO,    GOLD_BERRY,      EARTHQUAKE, ROCK_SLIDE, ICE_PUNCH, THUNDERPUNCH
	db 80, CROBAT,    GOLD_BERRY,     HYPNOSIS, GIGA_DRAIN, SLUDGE_BOMB, WING_ATTACK
	db 78, STEELIX,    GOLD_BERRY,        EARTHQUAKE, ROCK_SLIDE, SANDSTORM, IRON_TAIL
	db 81, FORRETRESS,    GOLD_BERRY,    ROCK_SMASH, GIGA_DRAIN, DOUBLE_EDGE, TOXIC
	db 80, BLISSEY,    GOLD_BERRY,    THUNDERBOLT, BLIZZARD, PSYCHIC_M, SOFTBOILED
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_ITEM_MOVES
	db 82, GOLDUCK,    GOLD_BERRY,      HYPNOSIS, HYDRO_PUMP, BLIZZARD, PSYCHIC_M
	db 80, STARMIE,    GOLD_BERRY,      RECOVER, HYDRO_PUMP, BLIZZARD, THUNDERBOLT
	db 83, GYARADOS,    GOLD_BERRY,     BODY_SLAM, HYDRO_PUMP, BLIZZARD, THUNDERBOLT
	db 85, POLITOED,    GOLD_BERRY,     HYPNOSIS, EARTHQUAKE, HYDRO_PUMP, BLIZZARD
	db 82, KINGDRA,    GOLD_BERRY,      SURF, BLIZZARD, DRAGONBREATH, REST
	db 80, TOGETIC,    GOLD_BERRY,      DOUBLE_EDGE, FIRE_BLAST, PSYCHIC_M, SHADOW_BALL
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_ITEM_MOVES
	db 86, ELECTRODE,    GOLD_BERRY,     HIDDEN_POWER, THUNDERBOLT, HYPER_BEAM, TOXIC
	db 84, MAGNETON,    GOLD_BERRY,  DOUBLE_TEAM, THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK
	db 87, JOLTEON,    GOLD_BERRY,   THUNDERBOLT, THUNDER_WAVE, DOUBLE_KICK, BODY_SLAM
	db 84, ELECTABUZZ,    GOLD_BERRY,  THUNDERBOLT, THUNDER_WAVE, ICE_PUNCH, PSYCHIC_M
	db 82, RAICHU,    GOLD_BERRY,   THUNDERBOLT, SUBMISSION, SURF, MEGA_KICK
	db 85, AMPHAROS,    GOLD_BERRY,  THUNDERBOLT, BODY_SLAM, FIRE_PUNCH, DYNAMICPUNCH
	db -1 ; end

ScientistGroup:
	; SCIENTIST (1)
	db "ROSS@", TRAINERTYPE_MOVES
	db 45, OMANYTE,     ANCIENTPOWER, AURORA_BEAM, BUBBLEBEAM, BITE
	db 45, KABUTO,      ANCIENTPOWER, DOUBLE_EDGE, MEGA_DRAIN, BUBBLEBEAM
	db -1 ; end
	...
	db 39, VOLTORB,      THUNDERBOLT, THUNDER_WAVE, SWIFT, ROLLOUT
	db 40, PORYGON,      THUNDERBOLT, THUNDER_WAVE, BLIZZARD, RECOVER
	db 39, VOLTORB,      THUNDERBOLT, THUNDER_WAVE, SWIFT, ROLLOUT
	db 42, ELECTRODE,      THUNDERBOLT, THUNDER_WAVE, EXPLOSION, ROLLOUT
	db -1 ; end

	; SCIENTIST (4)
	db "MARC@", TRAINERTYPE_MOVES
	db 55, MAGNETON,     THUNDERBOLT, THUNDER_WAVE, DOUBLE_TEAM, TRI_ATTACK
	db 53, ALAKAZAM,     PSYCHIC_M, RECOVER, ICE_PUNCH, THUNDERPUNCH
	db 55, RAICHU,       THUNDERBOLT, THUNDER_WAVE, SURF, MEGA_KICK
	db -1 ; end

	; SCIENTIST (5)
	db "RICH@", TRAINERTYPE_MOVES
	db 58, AERODACTYL,    ANCIENTPOWER, EARTHQUAKE, SKY_ATTACK, FIRE_BLAST
	db -1 ; end

ErikaGroup:
	; ERIKA (1)
	db "ERIKA@", TRAINERTYPE_ITEM_MOVES
	db 84, CLEFABLE,   LEFTOVERS,    THUNDERBOLT, BLIZZARD, PSYCHIC_M, SING
	db 86, TANGELA,   LEFTOVERS,   SLEEP_POWDER, BODY_SLAM, SLUDGE_BOMB, GIGA_DRAIN
	db 88, VICTREEBEL, LEFTOVERS,   SLEEP_POWDER, BODY_SLAM, SLUDGE_BOMB, RAZOR_LEAF
	db 86, VENUSAUR,  LEFTOVERS,   SLEEP_POWDER, SLUDGE_BOMB, RAZOR_LEAF, BODY_SLAM
	db 89, TAUROS,    LEFTOVERS,   BLIZZARD, EARTHQUAKE, HYPER_BEAM, BODY_SLAM
	db 85, EXEGGUTOR,  LEFTOVERS,   SLEEP_POWDER, EGG_BOMB, GIGA_DRAIN, PSYCHIC_M
	db -1 ; end
...
YoungsterGroup:
	...
	db 36, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end

	; YOUNGSTER (9)
	db "WARREN@", TRAINERTYPE_MOVES
	db 75, FEAROW,     DRILL_PECK, STEEL_WING, TRI_ATTACK, HYPER_BEAM
	db 75, SANDSLASH,     SLASH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end

	; YOUNGSTER (10)
	db "JIMMY@", TRAINERTYPE_MOVES
	db 71, RAICHU,     THUNDERBOLT, THUNDER_WAVE, SURF, MEGA_KICK
	db 73, ARCANINE,     EXTREMESPEED, FLAMETHROWER, CRUNCH, IRON_TAIL
	db 73, VENUSAUR,     SLEEP_POWDER, BODY_SLAM, SLUDGE_BOMB, RAZOR_LEAF
	db -1 ; end

	; YOUNGSTER (11)
	db "OWEN@", TRAINERTYPE_MOVES
	db 76, NINETALES,     FIRE_BLAST, BODY_SLAM, DIG, HYPNOSIS
	db 76, RAPIDASH,     EXTREMESPEED, FLAMETHROWER, CRUNCH, IRON_TAIL
	db 79, VICTREEBEL,     SLEEP_POWDER, BODY_SLAM, SLUDGE_BOMB, RAZOR_LEAF
	db -1 ; end

	; YOUNGSTER (12)
	db "JASON@", TRAINERTYPE_MOVES
	db 74, BEEDRILL,     SLUDGE_BOMB, HYPER_BEAM, SWORDS_DANCE, GIGA_DRAIN
	db 76, MACHAMP,     CROSS_CHOP, ROCK_SLIDE, EARTHQUAKE, FIRE_BLAST
	db 76, JOLTEON,     THUNDERBOLT, THUNDER_WAVE, PIN_MISSILE, DOUBLE_KICK
	db 78, DONPHAN,     EARTHQUAKE, ANCIENTPOWER, BODY_SLAM, HYPER_BEAM
	db -1 ; end

SchoolboyGroup:
	; SCHOOLBOY (1)
	db "JACK@", TRAINERTYPE_MOVES
	db 30, SEEL,    AURORA_BEAM, HEADBUTT, BUBBLEBEAM, REST
	db 32, MR__MIME,    CONFUSION, THUNDERBOLT, THUNDER_WAVE, HYPNOSIS
	db 30, DUNSPARCE,     GLARE, TAKE_DOWN, ANCIENTPOWER, SCREECH
	db -1 ; end

	; SCHOOLBOY (2)
	db "KIPP@", TRAINERTYPE_MOVES
	db 85, SMEARGLE,     THUNDER_WAVE, SUPER_FANG, CONFUSE_RAY, REFLECT
	db 81, SNORLAX,      BELLY_DRUM, BLIZZARD, EARTHQUAKE, THUNDER
	db -1 ; end
	...
	db 82, STARMIE,     THUNDERBOLT, HYDRO_PUMP, BLIZZARD, RECOVER
	db 82, SCIZOR,     STEEL_WING, AGILITY, SLASH, WING_ATTACK
	db 82, DONPHAN,     EARTHQUAKE, DOUBLE_EDGE, ANCIENTPOWER, BODY_SLAM
	db -1 ; end

	; SCHOOLBOY (5)
	db "DANNY@", TRAINERTYPE_MOVES
	db 68, FURRET,     ATTRACT, DOUBLE_EDGE, IRON_TAIL, SHADOW_BALL
	db 69, DEWGONG,     SURF, BLIZZARD, BODY_SLAM, HORN_DRILL
	db 70, DONPHAN,     EARTHQUAKE, DOUBLE_EDGE, ANCIENTPOWER, BODY_SLAM
	db 71, ELECTABUZZ, THUNDERBOLT, CROSS_CHOP, PSYCHIC_M, FIRE_PUNCH
	db -1 ; end

	; SCHOOLBOY (6)
	db "TOMMY@", TRAINERTYPE_MOVES
	db 80, GLIGAR,     GUILLOTINE, TOXIC, SLASH, WING_ATTACK
	db 83, ALAKAZAM,     PSYCHIC_M, RECOVER, ICE_PUNCH, THUNDERPUNCH
	db 83, HOUNDOOM,     FIRE_BLAST, CRUNCH, IRON_TAIL, SLUDGE_BOMB
	db -1 ; end

	; SCHOOLBOY (7)
	db "DUDLEY@", TRAINERTYPE_MOVES
	db 75, MR__MIME,     THUNDERBOLT, THUNDER_WAVE, PSYCHIC_M, LIGHT_SCREEN
	db 75, VILEPLUME,      SLEEP_POWDER, SLUDGE_BOMB, PETAL_DANCE, BODY_SLAM
	db 75, POLITOED,       HYPNOSIS, EARTHQUAKE, BLIZZARD, HYDRO_PUMP
	db -1 ; end

	; SCHOOLBOY (8)
	db "JOE@", TRAINERTYPE_NORMAL
	db 75, JOLTEON,     THUNDER_WAVE, THUNDERBOLT, DIG, SHADOW_BALL
	db 75, VAPOREON,    HYDRO_PUMP, BLIZZARD, BODY_SLAM, SHADOW_BALL
	db 75, FLAREON,     FIRE_BLAST, IRON_TAIL, SHADOW_BALL, DOUBLE_EDGE
	db -1 ; end

	; SCHOOLBOY (9)
	db "BILLY@", TRAINERTYPE_MOVES
	db 80, QUAGSIRE, BLIZZARD, SURF, EARTHQUAKE, BODY_SLAM
	db 81, MAGNETON, THUNDERBOLT, THUNDER_WAVE, DOUBLE_EDGE, DOUBLE_TEAM
	db 80, VENOMOTH, SLEEP_POWDER, PSYCHIC_M, SLUDGE_BOMB, MEGA_DRAIN
	db 83, ARCANINE, FIRE_BLAST, BODY_SLAM, IRON_TAIL, CRUNCH
	db -1 ; end
	...
	db 80, MAGCARGO, FIRE_BLAST, EARTHQUAKE, ROCK_SLIDE, SUNNY_DAY
	db 80, EXEGGUTOR, PSYCHIC_M, GIGA_DRAIN, EGG_BOMB, SLEEP_POWDER
	db -1 ; end
	...
	; SCHOOLBOY (13)
	db "JACK@", TRAINERTYPE_MOVES
	db 73, SUDOWOODO,   SANDSTORM, ROCK_SLIDE, EARTHQUAKE, SELFDESTRUCT
	db 70, SLOWBRO,    SURF, BLIZZARD, PSYCHIC_M, THUNDER_WAVE 
	db 73, DONPHAN,    EARTHQUAKE, ANCIENTPOWER, BODY_SLAM, SLEEP_TALK
	db 71, MAGNETON,    THUNDER_WAVE, THUNDERBOLT, DOUBLE_EDGE, DOUBLE_TEAM
	db 75, CORSOLA,    MIRROR_COAT, EARTHQUAKE, TOXIC, RECOVER
	db -1 ; end
