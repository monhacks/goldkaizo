...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_ITEM
	db 32, ARCANINE,      BRIGHTPOWDER
	db 32, STARMIE,  LEFTOVERS
	db 32, MAROWAK,    THICK_CLUB
	db 32, EXEGGUTOR,    MIRACLE_SEED
	db 32, ESPEON,    BRIGHTPOWDER
	db 32, BLISSEY,    LEFTOVERS
	db -1 ; end
