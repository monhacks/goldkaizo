...
BugsyGroup:
	...
	db 24, BEEDRILL,   TWINEEDLE, FURY_ATTACK, PURSUIT, SWORDS_DANCE
	db 24, BUTTERFREE,     CONFUSION, GUST, STUN_SPORE, SLEEP_POWDER
	db 24, PINSIR,     SEISMIC_TOSS, FALSE_SWIPE, FURY_CUTTER, VICEGRIP
	db 24, HERACROSS,    HORN_ATTACK, ENDURE, LOW_KICK, FALSE_SWIPE
	db 24, ARIADOS,     SONICBOOM, PSYBEAM, NIGHT_SHADE, PIN_MISSILE
	db 24, SCYTHER,    WING_ATTACK, FURY_CUTTER, SLASH, SWORDS_DANCE
	db -1 ; end
